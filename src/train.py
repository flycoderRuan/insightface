...
def parse_args():
  ...
  parser.add_argument('--margin_m', type=float, default=0.5, help='')
  parser.add_argument('--margin_s', type=float, default=64.0, help='')
  parser.add_argument('--margin_a', type=float, default=0.0, help='')
  parser.add_argument('--margin_b', type=float, default=0.0, help='')
  parser.add_argument('--easy_margin', type=int, default=0, help='')
  parser.add_argument('--margin_verbose', type=int, default=0, help='')
  parser.add_argument('--logits_verbose', type=int, default=0, help='')
  parser.add_argument('--c2c_threshold', type=float, default=0.0, help='')
  parser.add_argument('--c2c_mode', type=int, default=-10, help='')
  parser.add_argument('--output_c2c', type=int, default=0, help='')
  parser.add_argument('--train_limit', type=int, default=0, help='')
  parser.add_argument('--margin', type=int, default=4, help='')
  parser.add_argument('--beta', type=float, default=1000., help='')
  parser.add_argument('--beta_min', type=float, default=5., help='')
  parser.add_argument('--beta_freeze', type=int, default=0, help='')
  ...
  parser.add_argument('--center_alpha', type=float, default=0.5, help='')
  parser.add_argument('--center_scale', type=float, default=0.003, help='')
  parser.add_argument('--images_per_identity', type=int, default=0, help='')
  ...
  parser.add_argument('--loss_type', type=int, default=4, help='')
